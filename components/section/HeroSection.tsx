        ...
        <div className="flex-1">
          <div className="flex mb-3">
            <div className="inline-flex items-center gap-1 bg-[#F4F5F6] p-1 rounded-[100px] pr-[10px]">
              ...
              <p className="text-[#31373D] text-sm">BandaNaiera Project</p>
              <div>
                <ChevronRight />
              </div>
            </div>
          </div>
          <h1 className="mb-4 max-w-[600px] text-4xl lg:text-6xl font-medium my-4">
            Hi, I&apos;m Fatih UA
          </h1>
          ...
          <div className="inline-flex items-center gap-3 max-md:mx-auto mb-4">
            <Link
              href="/docs/ui"
              className={cn(
