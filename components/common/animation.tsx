...
export function CreateAppAnimation() {
  const installCmd = "fua create code-magic";
  const tickTime = 100;
  ...
  if (tick > timeCommandRun)
    lines.push(
      <Fragment key="command_response">
        <span className="font-bold">┌ Create Magic from Code</span>
        <span>│</span>
    ...
    >
      ...
      <pre className="overflow-hidden rounded-xl border text-xs">
        <div className="flex flex-row items-center gap-2 border-b px-4 py-2">
          ...
          <span className="font-bold">Ascodenote</span>
          <div className="grow" />
...
function LaunchAppWindow(
  ...
  return (
    ...
    >
      ...
      <div className="p-4 text-sm">The magic happens!</div>
    </div>
  );
}
