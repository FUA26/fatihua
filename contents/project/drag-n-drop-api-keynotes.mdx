...
summary: 'Elevate your development game with Husky, a powerful linting stage, and commit conventions for a seamless Next.js experience.'
images:
  [
    '/static/images/banners/nextjs-2.webp',
  ]
authors: ['default']
---
