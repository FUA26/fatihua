---
title: 'Next.js: Husky, Linting, and Commit Conventions'
date: '2023-06-25'
tags: ["nest","next", "backend"]
summary: 'Master the installation of NestJS and harness the potential of Global Configuration Variables with this step-by-step tutorial'
images:
  [
    '/static/images/banners/nestjs-1.webp',
  ]
authors: ['default']
---
